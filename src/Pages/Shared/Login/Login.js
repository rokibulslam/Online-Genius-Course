      ...
      <div className="form-wrapper">
        ...
        <div style={{ textAlign: "center" }}>
          ...
          <button className="social-button">
            <img style={{ width: "35px", borderRadius: "50%" }} src="https://i.ibb.co/MPcSmVD/download.png" alt="" />
          </button>{" "}
          <button className="social-button">
            <img style={{ width: "35px", borderRadius: "50%" }} src="https://i.ibb.co/8YNdYgm/download-1.png" alt="" />
          </button>
        </div>
        <div className="link">
